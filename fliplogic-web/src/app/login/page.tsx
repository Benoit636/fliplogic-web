    ...
    <main className="min-h-screen flex items-center justify-center bg-slate-100 px-4">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-sm border border-slate-200 p-10">
        <div className="flex justify-center mb-6">
          <img src="/fliplogic_logo.png" alt="FlipLogic" className="w-44 h-auto" />
        </div>
        <h2 className="text-2xl font-semibold text-center text-slate-900 mb-1">Sign in</h2>
        <p className="text-sm text-slate-500 text-center mb-7">Welcome back. Sign in to appraise vehicles.</p>
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <div className="flex items-center justify-between mb-1">
              ...
              <a href="#" className="text-xs font-medium text-blue-800 hover:text-blue-900">Forgot?</a>
            </div>
            <input
              id="password"
              type="password"
        ...
        <div className="text-center mt-6 text-sm text-slate-500">
          New dealer?{' '}
          <a href="/register" className="text-blue-800 hover:text-blue-900 font-semibold">Request access</a>
        </div>
      </div>
    </main>
  )
